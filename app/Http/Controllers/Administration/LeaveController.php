...
class LeaveController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        $leaves = LeaveRequest::query()
            ...
            ->with(['employee.department', 'employee.jobTitle', 'interimEmployee.department', 'interimEmployee.jobTitle', 'decidedBy'])
    ...
    public function print(Request $request, LeaveRequest $leave): Response
    {
        ...
        $leave->load(['employee.department', 'employee.jobTitle', 'interimEmployee.department', 'interimEmployee.jobTitle', 'decidedBy']);
