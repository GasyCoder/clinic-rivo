    ...
    <div class="w-full space-y-5">
        <header class="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
            <div class="flex items-start gap-3">
                ...
                <div><p class="text-xs font-medium uppercase tracking-wide text-muted-foreground">Super Administration · Laboratoire</p><h1 class="mt-0.5 font-heading text-2xl font-bold text-foreground">Modifier « {{ analysis.designation }} »</h1><p class="mt-1 text-sm text-muted-foreground">Site : {{ clinicSite.name }} · la prestation porte le tarif, cette fiche structure le résultat.</p></div>
            </div>
