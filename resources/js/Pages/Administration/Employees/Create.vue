...
defineProps({ options: Object, departments: Array, jobTitles: Array, addresses: [Array, Object], accounts: { type: Array, default: () => [] } });
...
<template>
    ...
    <div class="w-full space-y-5">
        ...
        <EmployeeForm :form="form" :options="options" :departments="departments" :job-titles="jobTitles" :addresses="addresses" :accounts="accounts" submit-label="Créer le dossier" cancel-href="/administration/employees" @submit="submit" />
    </div>
</template>
