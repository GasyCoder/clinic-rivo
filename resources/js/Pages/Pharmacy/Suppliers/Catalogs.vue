...
<template>
    ...
    <div class="w-full space-y-5">
        <Breadcrumb :items="[{ label: 'Fournisseurs', href: pharmacyUrl('/pharmacy/suppliers') }, { label: supplier.name, href: pharmacyUrl(`/pharmacy/suppliers/${supplier.uuid}`) }, { label: 'Catalogues' }]" />
        ...
        <SupplierCatalogFiles :supplier-name="supplier.name"
            :catalogs="catalogs"
            :can="can"
            :base-url="pharmacyUrl(`/pharmacy/suppliers/${supplier.uuid}/catalogs`)"
            :template-url="pharmacyUrl('/pharmacy/suppliers/catalog-template')"
        />
    </div>
</template>
