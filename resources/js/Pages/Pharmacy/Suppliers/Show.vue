...
const folders = computed(() => [
    {
        ...
        href: `/pharmacy/suppliers/${props.supplier.uuid}/catalogs`,
        title: 'Catalogues',
    ...
    },
    {
        ...
        href: `/pharmacy/purchase-orders?supplier=${props.supplier.uuid}`,
        title: 'Commandes',
    ...
    },
    {
        ...
        href: `/pharmacy/supplier-invoices?supplier=${props.supplier.uuid}`,
        title: 'Factures',
    ...
    },
    {
        ...
        href: `/pharmacy/suppliers/${props.supplier.uuid}/products`,
...
<template>
    ...
    <div class="w-full space-y-5">
        <Breadcrumb :items="[{ label: 'Fournisseurs', href: '/pharmacy/suppliers' }, { label: supplier.name }]" />
