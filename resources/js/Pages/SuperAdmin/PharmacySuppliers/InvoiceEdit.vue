    ...
    <div class="w-full space-y-5">
        ...
        <template v-else-if="invoice">
            <div>
                ...
                <p class="mt-1 text-sm text-slate-500">Facture de {{ supplier?.name }} sur le site {{ targetSite.name }}. Corriger une facture ne modifie jamais le stock ; sans nouveau document, le document actuel est conservé.</p>
            </div>
