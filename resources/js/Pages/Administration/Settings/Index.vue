...
<template>
    ...
    <div class="space-y-5">
        <HrNav />
        <HrPageHeader eyebrow="Référentiels configurables" title="Paramètres RH" description="Gérez les départements, fonctions, types de contrat et attestations utilisés dans les formulaires, sans modifier le code." icon="settings" tone="slate" />
