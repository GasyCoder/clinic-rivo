...
/**
 * ADR-113 — la fiche de régime, telle que la feuille papier de la clinique :
 * bandeau au logo, N° de dossier, nom, allergie, tabac, motif, puis la grille
 * jour / heure et ses quatre colonnes « Régime ». Des lignes vides complètent
 * la grille : la feuille imprimée reste utilisable au lit du patient.
 *
 * Un seul corps pour la fiche d'un séjour et pour les fiches réunies de
 * plusieurs séjours (ADR-165) : deux copies finiraient par diverger. Les
 * couleurs sont celles du papier, écrites en dur (même choix que l'ADR-108).
 */
