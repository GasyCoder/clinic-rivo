    ...
    <Card class="overflow-hidden shadow-sm">
        <form class="space-y-5 p-5" @submit.prevent="submit">
            <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                ...
                <label class="text-xs font-semibold text-slate-600 dark:text-slate-300">Code *<Input v-model="form.code" required placeholder="NFS-HB" /></label>
                ...
                <label class="text-xs font-semibold text-slate-600 dark:text-slate-300">Désignation *<Input v-model="form.designation" required placeholder="Hémoglobine" /></label>
