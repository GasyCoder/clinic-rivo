...
const invoiceHref = pharmacyUrl(`/pharmacy/supplier-invoices/${props.invoice.uuid}`);
</script>
...
<template>
    ...
    <div class="w-full space-y-5">
        <Breadcrumb :items="[{ label: 'Factures fournisseurs', href: pharmacyUrl('/pharmacy/supplier-invoices') }, { label: invoice.invoice_number, href: invoiceHref }, { label: 'Modifier' }]" />
