        ...
        <header class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex items-start gap-3">
                ...
                <div>
                    ...
                    <p class="mt-0.5 max-w-2xl text-sm leading-5 text-slate-400">
            ...
            <div class="overflow-x-auto">
                <table class="w-full min-w-[940px] border-collapse">
                    ...
                    <thead class="bg-gray-50/70 dark:bg-gray-1000/40">
                        <tr>
                            <th class="border-b border-gray-200 px-4 py-2.5 text-start text-[10px] font-bold uppercase tracking-wide text-slate-400 dark:border-gray-900">Patient</th>
                            <th class="border-b border-gray-200 px-4 py-2.5 text-start text-[10px] font-bold uppercase tracking-wide text-slate-400 dark:border-gray-900">Intervention</th>
                            <th class="border-b border-gray-200 px-4 py-2.5 text-start text-[10px] font-bold uppercase tracking-wide text-slate-400 dark:border-gray-900">Chirurgien</th>
                            <th class="border-b border-gray-200 px-4 py-2.5 text-start text-[10px] font-bold uppercase tracking-wide text-slate-400 dark:border-gray-900">Programmée le</th>
                            <th class="border-b border-gray-200 px-4 py-2.5 text-start text-[10px] font-bold uppercase tracking-wide text-slate-400 dark:border-gray-900">Statut</th>
                            <th class="border-b border-gray-200 px-4 py-2.5 text-end text-[10px] font-bold uppercase tracking-wide text-slate-400 dark:border-gray-900">Actions</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-900">
                        ...
                        >
                            <td class="px-4 py-3">
                                <div v-if="request.episode?.patient" class="flex min-w-[220px] items-center gap-3">
                                    ...
                                    <div class="min-w-0">
                                        <Link v-if="can('patients.view')" :href="`/patients/${request.episode.patient.uuid}`" class="block truncate text-sm font-bold text-slate-700 hover:text-primary-600 dark:text-white dark:hover:text-primary-400">
                            ...
                            <td class="px-4 py-3 text-end">
                                <Button :as="Link" :href="`/surgery/${request.uuid}`" size="rg" variant="white-outline" :aria-label="`Ouvrir le dossier ${request.procedure_name}`" title="Ouvrir le dossier">
                                    <Icon class="text-lg" name="eye" />
                                </Button>
                            </td>
                        </tr>
                        ...
                        <tr v-if="surgicalRequests.data.length === 0">
                            <td colspan="6" class="px-5 py-12 text-center">
                                ...
                                <p class="mt-1 text-xs text-slate-400">Modifiez la recherche ou créez une nouvelle demande.</p>
                            </td>
                        </tr>
                    </tbody>
                </table>
