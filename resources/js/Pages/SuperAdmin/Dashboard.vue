...
<template>
    ...
    <div class="w-full space-y-5">
        ...
        <section class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            ...
            <Link href="/super-admin/workspaces/administration" class="rounded-lg border border-gray-200 bg-white p-4 transition-colors hover:border-slate-300 dark:border-gray-900 dark:bg-gray-950 dark:hover:border-gray-700"><Icon class="text-xl text-slate-400" name="briefcase" /><h2 class="mt-3 text-sm font-bold text-slate-700 dark:text-white">Administration</h2><p class="mt-1 text-xs leading-5 text-slate-500">RH, logistique et gardiennage.</p></Link>
