    ...
    <div class="w-full space-y-5">
        <header class="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
            <div class="flex items-start gap-3">
                ...
                <div><p class="text-xs font-medium uppercase tracking-wide text-slate-400">Administration · Référentiel clinique</p><h1 class="mt-0.5 font-heading text-2xl font-bold text-slate-700 dark:text-white">Modifier « {{ analysis.designation }} »</h1><p class="mt-1 text-sm text-slate-500">La prestation porte la facturation ; cette fiche porte uniquement la structure du résultat.</p></div>
            </div>
        ...
        <AnalysisForm
            ...
            :submit-url="`/administration/analyses/${analysis.uuid}`"
            submit-method="put"
