...
class EpisodeNumberGeneratorTest extends TestCase
{
    ...
    public function test_first_number_is_prefixed_by_the_site_code_with_a_p_marker_and_zero_padded(): void
    {
        config(['rivo.site.code' => 'M']);

        $number = (new EpisodeNumberGenerator)->next();

        $this->assertSame('MP-000001', $number);
    }
    ...
    public function test_numbers_increment_sequentially(): void
    {
        ...
        $this->assertSame('AP-000001', $generator->next());
        $this->assertSame('AP-000002', $generator->next());
        $this->assertSame('AP-000003', $generator->next());
    }
    ...
    public function test_falls_back_to_a_placeholder_prefix_when_site_code_is_unset(): void
    {
        ...
        $this->assertSame('XP-000001', $number);
    }
    ...
    public function test_episode_and_patient_sequences_are_independent(): void
    {
        ...
        $this->assertSame('MP-000001', $episodeNumber);
