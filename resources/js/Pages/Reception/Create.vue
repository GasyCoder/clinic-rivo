        ...
        <Card class="overflow-hidden shadow-sm">
            ...
            <CardBody v-if="currentStep === 1" class="!p-5 lg:!p-7">
                <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                    ...
                    <Button v-if="capabilities.can_open_pharmacy_counter_sale" :as="Link" href="/pharmacy/counter-sales/create" size="rg" variant="white-outline"><Icon class="me-2" name="cart" />Vente comptoir Pharmacie</Button>
                </div>
                    ...
                    <section>
                        ...
                        <div v-else-if="!estimateCatalog.length" class="rounded-md border border-amber-200 bg-amber-50/70 px-5 py-6 dark:border-amber-900 dark:bg-amber-950/20">
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <Button v-if="capabilities.can_manage_catalog" class="mt-3" :as="Link" href="/administration/catalog" size="sm" variant="white-outline"><Icon class="me-2" name="setting" />Ouvrir Désignations & tarifs</Button>
                                </div>
                            </div>
                        </div>
                        <div v-else class="mt-3 rounded-md border border-dashed border-gray-300 px-5 py-8 text-center dark:border-gray-700">
                            ...
                            <template v-else>
                                ...
                                <Button v-if="selectedCatalogCategory.count === 0 && capabilities.can_manage_catalog" class="mt-3" :as="Link" href="/administration/catalog" size="sm" variant="white-outline"><Icon class="me-2" name="setting" />Configurer le catalogue</Button>
                ...
                <section v-else class="mt-5 w-full overflow-hidden rounded-md border border-gray-200 dark:border-gray-800">
                    ...
                    <div class="space-y-5 p-5">
                        ...
                        <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                            ...
                            <label><span class="mb-1.5 block text-sm font-medium text-slate-700 dark:text-white">Téléphone</span><IconInput v-model="patientForm.phone" size="lg" icon="call" type="tel" autocomplete="tel" placeholder="Ex. 034 00 000 00" :aria-invalid="Boolean(firstError(arrivalErrors, 'phone'))" /><FormError v-if="firstError(arrivalErrors, 'phone')" class="mt-1">{{ firstError(arrivalErrors, 'phone') }}</FormError></label>
                        </div>
                        <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
