...
<template>
    ...
    <div class="w-full space-y-5">
        ...
        <template v-else-if="supplier">
            <div>
                <h1 class="font-heading text-2xl font-bold text-slate-800 dark:text-white">Nouvelle commande · {{ supplier.name }}</h1>
                <p class="mt-1 text-sm text-slate-500">Enregistrée en brouillon sur le site {{ targetSite.name }}, à votre nom. Vous pourrez la vérifier avant de l’envoyer ; la réception se fera à la pharmacie du site.</p>
            </div>
