...
<template>
    ...
    <div class="w-full space-y-5">
        <HrNav />
        <HrPageHeader eyebrow="Cycle contractuel" title="Contrats du personnel" description="Suivez les engagements, leurs périodes et leurs archives, sans automatisation de paie." icon="file-docs" tone="sky">
