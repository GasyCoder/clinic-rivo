        ...
        <div class="grid gap-5 xl:grid-cols-[270px_minmax(0,1fr)]">
            ...
            <main class="min-w-0 space-y-4">
                ...
                <section class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-900 dark:bg-gray-950">
                    ...
                    <HrEmptyState v-else icon="setting" title="Aucune valeur configurée" description="Ajoutez la première valeur de ce référentiel pour la rendre disponible dans les formulaires." />
                </section>
